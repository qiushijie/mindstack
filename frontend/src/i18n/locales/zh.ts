export default {
  settings: {
    ...
    desc: {
      ...
      remoteUrl: '设置 Git 远程仓库地址，用于拉取和推送',
  ...
  editor: {
    ...
    gitSync: {
      ...
      sync: 'Git Sync',
      commitMessage: '提交信息...',
      initTitle: '初始化 Git 仓库',
      initMessage: '此文件夹还不是一个 git 仓库，是否要初始化？',
      initConfirm: '初始化',
      initCancel: '暂不',
      noRemote: '未配置远程仓库。请先在终端中设置 remote。',
      nothingToCommit: '没有可提交的内容。',
      commitSuccess: '已提交：{message}',
      pullSuccess: '拉取完成。',
      pushSuccess: '推送完成。',
      error: 'Git 错误：{error}',
      aiGenerate: 'AI 生成',
